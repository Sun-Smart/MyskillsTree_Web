"use strict";
(self["webpackChunkn_tire_angular"] = self["webpackChunkn_tire_angular"] || []).push([["projects_n-tire-biz-app_src_app_pages_forms_mstprofileaccessdetail_mstprofileaccessdetail_module_ts"],{

/***/ 36132:
/*!****************************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/mstprofileaccessdetail/mstprofileaccessdetail.component.ts ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mstprofileaccessdetailComponent": () => (/* binding */ mstprofileaccessdetailComponent)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tslib */ 3786);
/* harmony import */ var _E_FinalMSTGit_MyskillsTree_Web_node_modules_ngtools_webpack_src_loaders_direct_resource_js_mstprofileaccessdetail_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./mstprofileaccessdetail.component.html */ 40678);
/* harmony import */ var _service_mstprofileaccessdetail_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../service/mstprofileaccessdetail.service */ 1882);
...
let mstprofileaccessdetailComponent = class mstprofileaccessdetailComponent {
    constructor(nav, translate, keyboard, router, themeService, ngbDateParserFormatter, dialogRef, dynamicconfig, dialog, mstprofileaccessdetail_service, fb, sharedService, sessionService, toastr, sanitizer, currentRoute, spinner) {
        this.nav = nav;
        ...
        this.dialog = dialog;
        this.mstprofileaccessdetail_service = mstprofileaccessdetail_service;
        this.fb = fb;
        ...
        this.ShowTableslist = [];
        this.bfilterPopulate_mstprofileaccessdetails = false;
        this.mstprofileaccessdetail_menuactions = [];
        this.userid_optionsEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_7__.EventEmitter(); //autocomplete
        this.viewuserid_optionsEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_7__.EventEmitter(); //autocomplete
    ...
    prev() {
        debugger;
        let pos = this.pkList.map(function (e) { return e.viewid.toString(); }).indexOf(this.formid.toString());
        if (pos > 0)
    ...
    onSelected_viewuserid(viewuseridDetail) {
    ...
    onCopy() {
        ...
        if (this.formData.viewid != null)
            this.formData.viewid = null;
    }
    ...
    FillData(res) {
        ...
        this.pkcol = res.mstprofileaccessdetail.pkcol;
        this.bmyrecord = false;
        if (res.mstprofileaccessdetail.applicantid == this.sessionService.getItem('applicantid'))
            this.bmyrecord = true;
        console.log(res);
    ...
    onSubmitData(bclear) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.isSubmitted = true;
            let strError = "";
            // Object.keys(this.mstprofileaccessdetail_Form.controls).forEach(key => {
            //     const controlErrors: ValidationErrors = this.mstprofileaccessdetail_Form.get(key).errors;
            ...
            this.spinner.show();
            this.mstprofileaccessdetail_service.saveOrUpdate_mstprofileaccessdetails(this.formData).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push(res.mstprofileaccessdetail);
                if (!bclear)
                    this.showview = true;
...
mstprofileaccessdetailComponent.ctorParameters = () => [
    ...
    { type: _service_mstprofileaccessdetail_service__WEBPACK_IMPORTED_MODULE_1__.mstprofileaccessdetailService },
...
mstprofileaccessdetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-mstprofileaccessdetail',
        template: _E_FinalMSTGit_MyskillsTree_Web_node_modules_ngtools_webpack_src_loaders_direct_resource_js_mstprofileaccessdetail_component_html__WEBPACK_IMPORTED_MODULE_0__.default,
        providers: [ng_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_12__.KeyboardShortcutsService]
    })
], mstprofileaccessdetailComponent);
...
/***/ 88310:
/*!*************************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/mstprofileaccessdetail/mstprofileaccessdetail.module.ts ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mstprofileaccessdetailModule": () => (/* binding */ mstprofileaccessdetailModule)
/* harmony export */ });
...
/* harmony import */ var _mstprofileaccessdetail_routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mstprofileaccessdetail.routing */ 57126);
/* harmony import */ var _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mstprofileaccessdetail.component */ 36132);
...
let mstprofileaccessdetailModule = class mstprofileaccessdetailModule {
};
mstprofileaccessdetailModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        imports: [_n_tire_biz_app_src_app_pages_forms_boreportviewer_boreportviewer_module__WEBPACK_IMPORTED_MODULE_1__.boreportviewerModule,
            _mstprofileaccessdetail_routing__WEBPACK_IMPORTED_MODULE_2__.routing,
            _n_tire_biz_app_src_app_appcommon_module__WEBPACK_IMPORTED_MODULE_0__.NgCommonModule
        ],
        schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_5__.CUSTOM_ELEMENTS_SCHEMA],
        declarations: [_mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_3__.mstprofileaccessdetailComponent]
    })
], mstprofileaccessdetailModule);
...
/***/ 57126:
/*!**************************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/mstprofileaccessdetail/mstprofileaccessdetail.routing.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mstprofileaccessdetail.component */ 36132);
...
const routes = [
    {
        path: 'mstprofileaccessdetails', children: [
            { path: '', component: _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__.mstprofileaccessdetailComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'view/:viewid', pathMatch: 'prefix', component: _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__.mstprofileaccessdetailComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'view/:viewid/menu/:menuhide', pathMatch: 'prefix', component: _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__.mstprofileaccessdetailComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'edit/:id', component: _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__.mstprofileaccessdetailComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: _mstprofileaccessdetail_component__WEBPACK_IMPORTED_MODULE_0__.mstprofileaccessdetailComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] }
        ]
    }
];
...
/***/ 1882:
/*!***********************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/service/mstprofileaccessdetail.service.ts ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mstprofileaccessdetailService": () => (/* binding */ mstprofileaccessdetailService)
/* harmony export */ });
...
let mstprofileaccessdetailService = class mstprofileaccessdetailService {
    ...
    saveOrUpdate_mstprofileaccessdetails(formData) {
        if (this.valid()) {
            var body = Object.assign({}, formData);
            return this.http.post(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail', body);
        }
    }
    getDefaultData() {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/getdefaultdata').toPromise();
        }
    }
    get_mstprofileaccessdetails_List() {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail').toPromise();
        }
    }
    getListBy_viewid(viewid) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/viewid/' + viewid).toPromise();
        }
    }
    getList(key) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/param/' + key).toPromise();
        }
    }
    get_mstprofileaccessdetails_ByEID(id) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/e/' + id).toPromise();
        }
    }
    get_mstprofileaccessdetails_ByID(id) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/' + id).toPromise();
        }
    }
    delete_mstprofileaccessdetail(id) {
        if (this.valid()) {
            return this.http.delete(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/mstprofileaccessdetail' + '/' + id).toPromise();
        }
    }
    getList_userid() {
        return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirecrmURL + '/mstprofileaccessdetail' + '/getList_userid').toPromise();
    }
    getList_viewuserid() {
        return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirecrmURL + '/mstprofileaccessdetail' + '/getList_viewuserid').toPromise();
    }
};
mstprofileaccessdetailService.ctorParameters = () => [
...
mstprofileaccessdetailService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
        providedIn: 'root'
    })
], mstprofileaccessdetailService);
...
/***/ 40678:
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./projects/n-tire-biz-app/src/app/pages/forms/mstprofileaccessdetail/mstprofileaccessdetail.component.html ***!
  \*********************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
