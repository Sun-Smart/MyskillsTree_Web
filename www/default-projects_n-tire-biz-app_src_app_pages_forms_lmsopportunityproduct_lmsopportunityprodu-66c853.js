"use strict";
(self["webpackChunkn_tire_angular"] = self["webpackChunkn_tire_angular"] || []).push([["default-projects_n-tire-biz-app_src_app_pages_forms_lmsopportunityproduct_lmsopportunityprodu-66c853"],{

/***/ 61502:
/*!**************************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/lmsopportunityproduct/lmsopportunityproduct.component.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "lmsopportunityproductComponent": () => (/* binding */ lmsopportunityproductComponent)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tslib */ 3786);
/* harmony import */ var _E_FinalMSTGit_MyskillsTree_Web_node_modules_ngtools_webpack_src_loaders_direct_resource_js_lmsopportunityproduct_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./lmsopportunityproduct.component.html */ 28915);
/* harmony import */ var _service_lmsopportunityproduct_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../service/lmsopportunityproduct.service */ 95468);
...
let lmsopportunityproductComponent = class lmsopportunityproductComponent {
    constructor(nav, translate, keyboard, router, themeService, ngbDateParserFormatter, dialogRef, dynamicconfig, dialog, lmsopportunityproduct_service, fb, sharedService, sessionService, toastr, sanitizer, currentRoute, spinner) {
        this.nav = nav;
        ...
        this.lmsopportunityproduct_Form = this.fb.group({
            pk: [null],
            branchid: [null],
            leadid: [null],
            campaignid: [null],
    ...
    get f() { return this.lmsopportunityproduct_Form.controls; }
    ...
    canDeactivate() {
        debugger;
        if (this.lmsopportunityproduct_Form.dirty && this.lmsopportunityproduct_Form.touched) {
    ...
    prev() {
        debugger;
        let pos = this.pkList.map(function (e) { return e.opportunityproductid.toString(); }).indexOf(this.formid.toString());
        if (pos > 0)
    ...
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.lmsopportunityproduct_service.getDefaultData().then(res => {
            ...
            //autocomplete
            this.lmsopportunityproduct_service.get_lmsopportunityproducts_List().then(res => {
                this.pkList = res;
                this.pkoptionsEvent.emit(this.pkList);
            }).catch((err) => { this.spinner.hide(); console.log(err); });
            //setting the flag that the screen is not touched 
            this.lmsopportunityproduct_Form.markAsUntouched();
            this.lmsopportunityproduct_Form.markAsPristine();
        });
    }
    onSelected_opportunityid(opportunityidDetail) {
        if (opportunityidDetail.value && opportunityidDetail) {
            this.lmsopportunityproduct_Form.patchValue({
    ...
    resetForm() {
        if (this.lmsopportunityproduct_Form != null)
            this.lmsopportunityproduct_Form.reset();
        this.lmsopportunityproduct_Form.patchValue({});
        this.PopulateFromMainScreen(this.data, false);
        this.PopulateFromMainScreen(this.dynamicconfig.data, true);
    }
    onDelete() {
        let opportunityproductid = this.lmsopportunityproduct_Form.get('opportunityproductid').value;
        if (opportunityproductid != null) {
            if (confirm('Are you sure to delete this record ?')) {
                this.lmsopportunityproduct_service.delete_lmsopportunityproduct(opportunityproductid).then(res => {
                    this.resetForm();
                }).catch((err) => { this.spinner.hide(); console.log(err); });
            }
        }
    ...
    onCopy() {
        ...
        if (this.formData.opportunityproductid != null)
            this.formData.opportunityproductid = null;
    }
            ...
            for (let key in mainscreendata) {
                if (key != 'visiblelist' && key != 'hidelist' && key != 'event') {
                    ...
                    if (false)
                        ...
                        this.lmsopportunityproduct_Form.patchValue({ [key]: mainscreendata[key] });
                    }
                    else {
                        this.lmsopportunityproduct_Form.patchValue({ [key]: mainscreendata[key] });
                    }
                    {
                        {
                            if (bdisable && this.lmsopportunityproduct_Form.controls[key] != undefined) {
                                this.lmsopportunityproduct_Form.controls[key].disable({ onlySelf: true });
    ...
    productid_onChange(evt) {
        let e = evt.value;
        this.lmsopportunityproduct_Form.patchValue({ productiddesc: evt.options[evt.options.selectedIndex].text });
    }
    uom_onChange(evt) {
        let e = this.f.uom.value;
        this.lmsopportunityproduct_Form.patchValue({ uomdesc: evt.options[evt.options.selectedIndex].text });
    }
    edit_lmsopportunityproducts() {
        this.showview = false;
        setTimeout(() => {
        });
        return false;
    ...
    PopulateScreen(pkcol) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            this.spinner.show();
            this.lmsopportunityproduct_service.get_lmsopportunityproducts_ByEID(pkcol).then(res => {
                this.spinner.hide();
                this.formData = res.lmsopportunityproduct;
    ...
    FillData(res) {
        ...
        this.pkcol = res.lmsopportunityproduct.pkcol;
        this.bmyrecord = false;
        if (res.lmsopportunityproduct.applicantid == this.sessionService.getItem('applicantid'))
            this.bmyrecord = true;
        console.log(res);
    ...
    getHtml(html) {
        let ret = "";
        ret = html;
        for (let key in this.lmsopportunityproduct_Form.controls) {
            let val = this.lmsopportunityproduct_Form.controls[key].value;
            if (val == 'null' || val == null || val == undefined)
                val = '';
            if (this.lmsopportunityproduct_Form.controls[key] != null) {
                if (false) {}
                else if (false) {}
                else if (false) {}
                else
    ...
    onSubmitDataDlg(bclear) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!this.lmsopportunityproduct_Form.valid) {
                this.toastr.addSingle("error", "", "Enter the required fields");
                return;
            }
            var obj = this.lmsopportunityproduct_Form.getRawValue();
            console.log(obj);
    ...
    onSubmitData(bclear) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.isSubmitted = true;
            let strError = "";
            // Object.keys(this.lmsopportunityproduct_Form.controls).forEach(key => {
            //     const controlErrors: ValidationErrors = this.lmsopportunityproduct_Form.get(key).errors;
            ...
            this.formData = this.lmsopportunityproduct_Form.getRawValue();
            if (this.dynamicconfig.data != null) {
                for (let key in this.dynamicconfig.data) {
                    if (key != 'visiblelist' && key != 'hidelist') {
                        if (this.lmsopportunityproduct_Form.controls[key] != null) {
                            this.formData[key] = this.lmsopportunityproduct_Form.controls[key].value;
                        }
                    }
                }
            }
            ...
            this.spinner.show();
            this.lmsopportunityproduct_service.saveOrUpdate_lmsopportunityproducts(this.formData).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push(res.lmsopportunityproduct);
                if (!bclear)
                    this.showview = true;
...
lmsopportunityproductComponent.ctorParameters = () => [
    ...
    { type: _service_lmsopportunityproduct_service__WEBPACK_IMPORTED_MODULE_1__.lmsopportunityproductService },
...
lmsopportunityproductComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-lmsopportunityproduct',
        template: _E_FinalMSTGit_MyskillsTree_Web_node_modules_ngtools_webpack_src_loaders_direct_resource_js_lmsopportunityproduct_component_html__WEBPACK_IMPORTED_MODULE_0__.default,
        providers: [ng_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_13__.KeyboardShortcutsService]
    })
], lmsopportunityproductComponent);
...
/***/ 43069:
/*!***********************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/lmsopportunityproduct/lmsopportunityproduct.module.ts ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "lmsopportunityproductModule": () => (/* binding */ lmsopportunityproductModule)
/* harmony export */ });
...
/* harmony import */ var _lmsopportunityproduct_routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lmsopportunityproduct.routing */ 94030);
/* harmony import */ var _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lmsopportunityproduct.component */ 61502);
...
let lmsopportunityproductModule = class lmsopportunityproductModule {
};
lmsopportunityproductModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        imports: [_n_tire_biz_app_src_app_pages_forms_boreportviewer_boreportviewer_module__WEBPACK_IMPORTED_MODULE_1__.boreportviewerModule,
            _lmsopportunityproduct_routing__WEBPACK_IMPORTED_MODULE_2__.routing,
            _n_tire_biz_app_src_app_appcommon_module__WEBPACK_IMPORTED_MODULE_0__.NgCommonModule
        ],
        schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_5__.CUSTOM_ELEMENTS_SCHEMA],
        declarations: [_lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_3__.lmsopportunityproductComponent]
    })
], lmsopportunityproductModule);
...
/***/ 94030:
/*!************************************************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/pages/forms/lmsopportunityproduct/lmsopportunityproduct.routing.ts ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lmsopportunityproduct.component */ 61502);
...
const routes = [
    {
        path: 'lmsopportunityproducts', children: [
            { path: '', component: _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_0__.lmsopportunityproductComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'edit/:id', component: _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_0__.lmsopportunityproductComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'view/:viewid', component: _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_0__.lmsopportunityproductComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: _lmsopportunityproduct_component__WEBPACK_IMPORTED_MODULE_0__.lmsopportunityproductComponent, canDeactivate: [_n_tire_biz_app_src_app_pages_common_unsaved_changes__WEBPACK_IMPORTED_MODULE_1__.CanDeactivateGuard] }
        ]
    }
];
...
/***/ 95468:
/*!**********************************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/service/lmsopportunityproduct.service.ts ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "lmsopportunityproductService": () => (/* binding */ lmsopportunityproductService)
/* harmony export */ });
...
let lmsopportunityproductService = class lmsopportunityproductService {
    ...
    saveOrUpdate_lmsopportunityproducts(formData) {
        if (this.valid()) {
            var body = Object.assign({}, formData);
            return this.http.post(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct', body);
        }
    }
    getDefaultData() {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/getdefaultdata').toPromise();
        }
    }
    get_lmsopportunityproducts_List() {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct').toPromise();
        }
    }
    getListBy_opportunityproductid(opportunityproductid) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/opportunityproductid/' + opportunityproductid).toPromise();
        }
    }
    getList(key) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/param/' + key).toPromise();
        }
    }
    get_lmsopportunityproducts_ByEID(id) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/e/' + id).toPromise();
        }
    }
    get_lmsopportunityproducts_ByID(id) {
        if (this.valid()) {
            return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/' + id).toPromise();
        }
    }
    delete_lmsopportunityproduct(id) {
        if (this.valid()) {
            return this.http.delete(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirebizURL + '/lmsopportunityproduct' + '/' + id).toPromise();
        }
    }
    getList_opportunityid() {
        return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirecrmURL + '/lmsopportunityproduct' + '/getList_opportunityid').toPromise();
    }
    getList_productid() {
        return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirecrmURL + '/lmsopportunityproduct' + '/getList_productid').toPromise();
    }
    getList_uom() {
        return this.http.get(_n_tire_biz_app_src_app_shared_helper__WEBPACK_IMPORTED_MODULE_0__.AppConstants.ntirecrmURL + '/lmsopportunityproduct' + '/getList_uom/').toPromise();
    }
};
lmsopportunityproductService.ctorParameters = () => [
...
lmsopportunityproductService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
/***/ 28915:
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./projects/n-tire-biz-app/src/app/pages/forms/lmsopportunityproduct/lmsopportunityproduct.component.html ***!
  \*******************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
