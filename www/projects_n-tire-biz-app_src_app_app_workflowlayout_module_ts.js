"use strict";
(self["webpackChunkn_tire_angular"] = self["webpackChunkn_tire_angular"] || []).push([["projects_n-tire-biz-app_src_app_app_workflowlayout_module_ts"],{

/***/ 94435:
/*!**********************************************************************!*\
  !*** ./projects/n-tire-biz-app/src/app/app.workflowlayout.module.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NgWorkFlowModule": () => (/* binding */ NgWorkFlowModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 3786);
/* harmony import */ var _appcommon_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appcommon.module */ 60521);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 2316);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ 54364);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ 71258);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ 1707);
/* harmony import */ var _app_layout_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app.layout.module */ 33562);
        ...
        children: [

            {
                ...
                children: [
                    ...
                    { path: 'crmtatconfigurations', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/crmtatconfiguration/crmtatconfiguration.module').then(m => m.crmtatconfigurationModule) },


                    { path: 'erppurchaserequests', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erppurchaserequest/erppurchaserequest.module').then(m => m.erppurchaserequestModule) },
                    ...
                    { path: 'automasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/automaster/automaster.module').then(m => m.automasterModule) },
                    { path: 'bobranchmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bobranchmaster/bobranchmaster.module').then(m => m.bobranchmasterModule) },
                    { path: 'bolmsbranchmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bolmsbranchmaster/bolmsbranchmaster.module').then(m => m.bolmsbranchmasterModule) },
                    { path: 'bocities', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bocity/bocity.module').then(m => m.bocityModule) },
                    { path: 'bocompanybankdetails', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bocompanybankdetail/bocompanybankdetail.module').then(m => m.bocompanybankdetailModule) },
                    { path: 'bocompanymasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bocompanymaster/bocompanymaster.module').then(m => m.bocompanymasterModule) },
                    { path: 'boconfigvalues', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boconfigvalue/boconfigvalue.module').then(m => m.boconfigvalueModule) },
                    ...
                    { path: 'boserialkeyparameters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boserialkeyparameter/boserialkeyparameter.module').then(m => m.boserialkeyparameterModule) },
                    { path: 'bocompanysettings', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bocompanysetting/bocompanysetting.module').then(m => m.bocompanysettingModule) },
                    { path: 'bodashboards', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bodashboard/bodashboard.module').then(m => m.bodashboardModule) },


                    { path: 'bodynamicforms', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bodynamicform/bodynamicform.module').then(m => m.bodynamicformModule) },
                    { path: 'bodynamicformviewers', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bodynamicformviewer/bodynamicformviewer.module').then(m => m.bodynamicformviewerModule) },
                    { path: 'bokbmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bokbmaster/bokbmaster.module').then(m => m.bokbmasterModule) },
                    { path: 'bomasterdatas', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bomasterdata/bomasterdata.module').then(m => m.bomasterdataModule) },
                    { path: 'bomasterdatatypes', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bomasterdatatype/bomasterdatatype.module').then(m => m.bomasterdatatypeModule) },
                    { path: 'bomenumasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bomenumaster/bomenumaster.module').then(m => m.bomenumasterModule) },
                    { path: 'bonotificationsettings', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bonotificationsetting/bonotificationsetting.module').then(m => m.bonotificationsettingModule) },
                    { path: 'boreports', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boreport/boreport.module').then(m => m.boreportModule) },
                    { path: 'boreportviewer', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boreportviewer/boreportviewer.module').then(m => m.boreportviewerModule) },
                    { path: 'boreportviewer/:id', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boreportviewer/boreportviewer.module').then(m => m.boreportviewerModule) },
                    { path: 'bostates', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bostate/bostate.module').then(m => m.bostateModule) },
                    { path: 'botables', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/botable/botable.module').then(m => m.botableModule) },
                    { path: 'botableconfigurations', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/botableconfiguration/botableconfiguration.module').then(m => m.botableconfigurationModule) },
                    { path: 'bousermasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bousermaster/bousermaster.module').then(m => m.bousermasterModule) },
                    { path: 'bouserrolemasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/bouserrolemaster/bouserrolemaster.module').then(m => m.bouserrolemasterModule) },
                    { path: 'boworkflowmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/boworkflowmaster/boworkflowmaster.module').then(m => m.boworkflowmasterModule) },
                    ...
                    { path: 'customfieldconfigurations', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/customfieldconfiguration/customfieldconfiguration.module').then(m => m.customfieldconfigurationModule) },
                    ...
                    { path: 'erpbudgetmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpbudgetmaster/erpbudgetmaster.module').then(m => m.erpbudgetmasterModule) },
                    { path: 'erpgoodsreceiptmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpgoodsreceiptmaster/erpgoodsreceiptmaster.module').then(m => m.erpgoodsreceiptmasterModule) },
                    { path: 'erpiltmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpiltmaster/erpiltmaster.module').then(m => m.erpiltmasterModule) },
                    { path: 'erpitemmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpitemmaster/erpitemmaster.module').then(m => m.erpitemmasterModule) },
                    { path: 'erplocationmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erplocationmaster/erplocationmaster.module').then(m => m.erplocationmasterModule) },
                    { path: 'erpmaterialrequests', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpmaterialrequest/erpmaterialrequest.module').then(m => m.erpmaterialrequestModule) },
                    { path: 'erpphysicalinventorymasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpphysicalinventorymaster/erpphysicalinventorymaster.module').then(m => m.erpphysicalinventorymasterModule) },
                    { path: 'erpproductfeatureparameters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpproductfeatureparameter/erpproductfeatureparameter.module').then(m => m.erpproductfeatureparameterModule) },
                    { path: 'erppurchaseorderdetails', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erppurchaseorderdetail/erppurchaseorderdetail.module').then(m => m.erppurchaseorderdetailModule) },
                    { path: 'erppurchaseordermasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erppurchaseordermaster/erppurchaseordermaster.module').then(m => m.erppurchaseordermasterModule) },
                    { path: 'erppurchaserequests', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erppurchaserequest/erppurchaserequest.module').then(m => m.erppurchaserequestModule) },
                    { path: 'erprfqdetails', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erprfqdetail/erprfqdetail.module').then(m => m.erprfqdetailModule) },
                    { path: 'erprfqmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erprfqmaster/erprfqmaster.module').then(m => m.erprfqmasterModule) },
                    { path: 'erpsupplieritems', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpsupplieritem/erpsupplieritem.module').then(m => m.erpsupplieritemModule) },
                    { path: 'erpsuppliermasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpsuppliermaster/erpsuppliermaster.module').then(m => m.erpsuppliermasterModule) },
                    { path: 'erpsupplierpackingdetails', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpsupplierpackingdetail/erpsupplierpackingdetail.module').then(m => m.erpsupplierpackingdetailModule) },
                    { path: 'erpsupplierpackingmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpsupplierpackingmaster/erpsupplierpackingmaster.module').then(m => m.erpsupplierpackingmasterModule) },
                    { path: 'erpsupplierquotationmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpsupplierquotationmaster/erpsupplierquotationmaster.module').then(m => m.erpsupplierquotationmasterModule) },
                    { path: 'erptaxmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erptaxmaster/erptaxmaster.module').then(m => m.erptaxmasterModule) },
                    { path: 'field-error-displays', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/field-error-display/field-error-display.module').then(m => m.FieldErrorDisplayModule) },
                    ...
                    { path: 'lmspendings', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/lmspending/lmspending.module').then(m => m.lmspendingModule) },
                    { path: 'lmsproducts', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/lmsproduct/lmsproduct.module').then(m => m.lmsproductModule) },
                    ...
                    { path: 'systemcolumns', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/systemcolumn/systemcolumn.module').then(m => m.systemcolumnModule) },
                    { path: 'systemtables', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/systemtable/systemtable.module').then(m => m.systemtableModule) },
                    { path: 'workflowmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/workflowmaster/workflowmaster.module').then(m => m.workflowmasterModule) },
                    { path: 'erpfaaccountperiodmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaaccountperiodmaster/erpfaaccountperiodmaster.module').then(m => m.erpfaaccountperiodmasterModule) },
                    { path: 'erpfacostcategories', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfacostcategory/erpfacostcategory.module').then(m => m.erpfacostcategoryModule) },
                    { path: 'erpfaaccountmasters', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaaccountmaster/erpfaaccountmaster.module').then(m => m.erpfaaccountmasterModule) },
                    { path: 'erpfabankaccounts', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfabankaccount/erpfabankaccount.module').then(m => m.erpfabankaccountModule) },
                    { path: 'erpfamergeaccounts', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfamergeaccount/erpfamergeaccount.module').then(m => m.erpfamergeaccountModule) },
                    { path: 'erpfachequebooks', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfachequebook/erpfachequebook.module').then(m => m.erpfachequebookModule) },
                    { path: 'erpfachequestatuses', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfachequestatus/erpfachequestatus.module').then(m => m.erpfachequestatusModule) },
                    { path: 'erpfacostcategoryglmappings', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfacostcategoryglmapping/erpfacostcategoryglmapping.module').then(m => m.erpfacostcategoryglmappingModule) },
                    { path: 'erpfaaccountbalancefinyears', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaaccountbalancefinyear/erpfaaccountbalancefinyear.module').then(m => m.erpfaaccountbalancefinyearModule) },
                    { path: 'erpfaaccountbalancemonths', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaaccountbalancemonth/erpfaaccountbalancemonth.module').then(m => m.erpfaaccountbalancemonthModule) },
                    { path: 'erpfajournals', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfajournal/erpfajournal.module').then(m => m.erpfajournalModule) },
                    { path: 'erpfacreditdebitnotes', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfacreditdebitnote/erpfacreditdebitnote.module').then(m => m.erpfacreditdebitnoteModule) },
                    { path: 'erpfaarbookings', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaarbooking/erpfaarbooking.module').then(m => m.erpfaarbookingModule) },
                    { path: 'erpfaapentries', loadChildren: () => import('../../../n-tire-biz-app/src/app/pages/forms/erpfaapentry/erpfaapentry.module').then(m => m.erpfaapentryModule) },
...
let NgWorkFlowModule = class NgWorkFlowModule {
};
NgWorkFlowModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        exports: [],
        declarations: [],
        imports: [
            _appcommon_module__WEBPACK_IMPORTED_MODULE_0__.NgCommonModule,
            _angular_router__WEBPACK_IMPORTED_MODULE_4__.RouterModule.forChild(_app_layout_module__WEBPACK_IMPORTED_MODULE_1__.paths),
...
//# sourceMappingURL=projects_n-tire-biz-app_src_app_app_workflowlayout_module_ts.js.map