...
import { LoginComponent } from '../../../n-tire-bo-app/src/app/pages/login/login.component';
...
import { LayoutComponent } from '../../../n-tire-bo-app/src/app/pages/layout/layout/layout.component';
import { bodlgviewerComponent } from '../../../n-tire-bo-app/src/app/pages/forms/boreportviewer/bodlgviewer.component';
...
const routes: Routes = [
    ...
    { path: 'wk', pathMatch:"Prefix", outlet:"modal", loadChildren: () => import('../../../n-tire-cams-app/src/app/pages/forms/camsworkrequest/camsworkrequest.module').then(m => m.camsworkrequestModule) },
    { path: 'camsworkrequests',pathMatch:"Prefix", outlet:'modal', loadChildren: () => import('../../../n-tire-cams-app/src/app/pages/forms/camsworkrequest/camsworkrequest.module').then(m => m.camsworkrequestModule) },
    {
        path: 'workflow',
