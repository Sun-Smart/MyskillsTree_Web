...
export class LayoutComponent implements OnInit,AfterViewInit {//
    ...
    constructor(private router: Router, private toastService: ToastService,
        ...
        hide(e) {
            /*
            var divsToHide = document.getElementsByClassName("collapse"); //divsToHide is an array
            for(var i = 0; i < divsToHide.length; i++){
                //(divsToHide[i]as any).style.visibility = "hidden"; // or
                (divsToHide[i]as any).style.visibility = "hidden"; // depending on what you're doing
            }
            */
           
            var elemToHide = e.target.parentElement.parentElement.parentElement;
    ...
    show()
    {
        ...
        for(var i = 0; i < divsToHide.length; i++){
            //(divsToHide[i]as any).style.visibility = "hidden"; // or
            (divsToHide[i]as any).style.visibility = "block"; // depending on what you're doing
        } 
    }
    */
    OpenPage(e:any) {
