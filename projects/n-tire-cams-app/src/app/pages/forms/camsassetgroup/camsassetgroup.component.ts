...
//FK field services
import { bosubconfigvalue} from '../../../../../../n-tire-bo-app/src/app/model/bosubconfigvalue.model';
import { bosubconfigvalueComponent } from '../../../../../../n-tire-bo-app/src/app/pages/forms/bosubconfigvalue/bosubconfigvalue.component';
import { bosubconfigvalueService } from '../../../../../../n-tire-bo-app/src/app/service/bosubconfigvalue.service';
//popups
...
datacamsassetgroupsuom3:any=[];
datacamsassetgroupscategory3:any=[];
datacamsassetgroupssubcategory3:any=[];
...
subcategoryList: bosubconfigvalue[];
...
camsassetgroupshowOption:boolean;
sessiondata:any;
sourcekey:any;
...
this.camsassetgroupForm  = this.fb.group({
pk:[null],
ImageName: [null],
assetgroupid: [null],
...
{
this.subcategoryList = res as bosubconfigvalue[];
}
...
if (assetaccountDetail.accountid && assetaccountDetail) {
this.camsassetgroupForm.patchValue({
assetaccount: assetaccountDetail.accountid,
...
if (maintenanceaccountDetail.accountid && maintenanceaccountDetail) {
this.camsassetgroupForm.patchValue({
maintenanceaccount: maintenanceaccountDetail.accountid,
...
if (leasecostaccountDetail.accountid && leasecostaccountDetail) {
this.camsassetgroupForm.patchValue({
leasecostaccount: leasecostaccountDetail.accountid,
...
if (disposallossaccountDetail.accountid && disposallossaccountDetail) {
this.camsassetgroupForm.patchValue({
disposallossaccount: disposallossaccountDetail.accountid,
...
if (disposalgainaccountDetail.accountid && disposalgainaccountDetail) {
this.camsassetgroupForm.patchValue({
disposalgainaccount: disposalgainaccountDetail.accountid,
...
if (depreciationaccountDetail.accountid && depreciationaccountDetail) {
this.camsassetgroupForm.patchValue({
depreciationaccount: depreciationaccountDetail.accountid,
...
if (accumdepreciationaccountDetail.accountid && accumdepreciationaccountDetail) {
this.camsassetgroupForm.patchValue({
accumdepreciationaccount: accumdepreciationaccountDetail.accountid,
...
this.camsassetgroupForm.patchValue({"postingdate":this.ngbDateParserFormatter.parse(mainscreendata[key]) });
        else if(key=="remarks")
this.camsassetgroupForm.patchValue({"remarks":  mainscreendata[key] } );
        else if(ctrltype=="string")
{
this.camsassetgroupForm.patchValue({[key]:  mainscreendata[key] } );
}
        else
{
this.camsassetgroupForm.patchValue({[key]:  mainscreendata[key] } );
...
{
{
         if(bdisable && this.camsassetgroupForm.controls[key]!=undefined)
{
this.camsassetgroupForm.controls[key].disable({onlySelf: true});
...
this.camsassetgroupForm.patchValue({uomdesc:evt.options[evt.options.selectedIndex].text});
}
categoryonChange(evt:any){
let e=this.f.category.value as any;
this.camsassetgroupForm.patchValue({categorydesc:evt.options[evt.options.selectedIndex].text});
}
subcategoryonChange(evt:any){
let e=evt.value;
this.camsassetgroupForm.patchValue({subcategorydesc:evt.options[evt.options.selectedIndex].text});
}
...
this.camsassetgroupservice.getcamsassetgroupsByEID(pkcol).then(res => {

this.camsassetgroupservice.formData=res.camsassetgroup;
let formproperty=res.camsassetgroup.formproperty;
if(formproperty && formproperty.edit==false)this.showview=true;
this.pkcol=res.camsassetgroup.pkcol;
...
uom: res.camsassetgroup.uom,
uomdesc: res.camsassetgroup.uomdesc,
category: res.camsassetgroup.category,
categorydesc: res.camsassetgroup.categorydesc,
subcategory: res.camsassetgroup.subcategory,
subcategorydesc: res.camsassetgroup.subcategorydesc,
...
attachment: JSON.parse(res.camsassetgroup.attachment),
...
this.FillCustomField();
if(this.camsassetgroupForm.get('attachment').value!=null && this.camsassetgroupForm.get('attachment').value!="" && this.fileattachment!=null && this.fileattachment!=undefined)this.fileattachment.setattachmentlist(this.camsassetgroupForm.get('attachment').value);
//Child Tables if any
}
...
if(false)
{
if(this.camsassetgroupservice.formData!=null && this.camsassetgroupservice.formData[key]!=null  && this.camsassetgroupservice.formData[key]!='[]' && this.camsassetgroupservice.formData[key]!=undefined && this.camsassetgroupservice.formData[key].length>0)ret = ret.replace(new RegExp('##' + key + '##', 'g'),"http://localhost:5002/"+ JSON.parse(this.camsassetgroupservice.formData[key])[0]["name"]);
}
else if(false)
{
if(this.camsassetgroupservice.formData!=null && this.camsassetgroupservice.formData[key]!=null   && this.camsassetgroupservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='Stars' style='--rating:"+ this.camsassetgroupservice.formData[key]+"></div>");
}
else if(false)
{
if(this.camsassetgroupservice.formData!=null && this.camsassetgroupservice.formData[key]!=null   && this.camsassetgroupservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='progress--circle progress--"+this.camsassetgroupservice.formData[key]+"'><div class='progress__number'>"+this.camsassetgroupservice.formData[key]+"%</div></div>");
}
else
...
obj.postingdate=new Date(this.camsassetgroupForm.get('postingdate').value ? this.ngbDateParserFormatter.format(this.camsassetgroupForm.get('postingdate').value)+'  UTC' :null);
if(this.camsassetgroupForm.get('remarks').value!=null)obj.remarks=JSON.stringify(this.camsassetgroupForm.get('remarks').value);
...
private camsassetgrouptoggleOption(){
this.camsassetgroupshowOption = this.camsassetgroupshowOption === true ? false : true;
}
...
var customfields=this.customfieldservice.getCustomValues(document);
this.camsassetgroupservice.formData.postingdate=new Date(this.camsassetgroupForm.get('postingdate').value ? this.ngbDateParserFormatter.format(this.camsassetgroupForm.get('postingdate').value)+'  UTC' :null);
if(this.camsassetgroupForm.get('remarks').value!=null)this.camsassetgroupservice.formData.remarks=JSON.stringify(this.camsassetgroupForm.get('remarks').value);
if(customfields!=null)this.camsassetgroupservice.formData.customfield=JSON.stringify(customfields);
if(this.fileattachment.getattachmentlist()!=null)this.camsassetgroupservice.formData.attachment=JSON.stringify(this.fileattachment.getattachmentlist());
...
{
this.dialogRef.close((res as any).camsassetgroup);
    return;
}
else
{
...
AddOrEditsubcategory( subconfigcode) {
/*let ScreenType='2';
this.dialog.open(bosubconfigvalueComponent, 
{
data: {subconfigcode:this.camsassetgroupForm.get('subcategory').value, ScreenType:2 }
} 
