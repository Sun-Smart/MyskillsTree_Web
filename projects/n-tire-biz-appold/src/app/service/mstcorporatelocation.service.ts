...
export class mstcorporatelocationService {
  ...
  getList_stateid(): any {
    return this.http.get(AppConstants.ntirecrmURL + '/mstcorporatelocation' + '/getList_stateid').toPromise();
  }

  getList_cityid(): any {
    return this.http.get(AppConstants.ntirecrmURL + '/mstcorporatelocation' + '/getList_cityid').toPromise();
  }
