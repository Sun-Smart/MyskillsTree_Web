...
export class lmsbundledproductComponent implements OnInit {
    ...
    lmsbundledproduct_Form: FormGroup;
    ...
    constructor(
        ...
        private lmsbundledproduct_service: lmsbundledproductService,
    ...
    onCopy() {
        ...
        if (this.formData.bundleproductid != null) this.formData.bundleproductid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.lmsbundledproduct as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.lmsbundledproduct_service.saveOrUpdate_lmsbundledproducts(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).lmsbundledproduct);
