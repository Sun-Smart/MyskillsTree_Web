...
export class hlpticketdetailComponent implements OnInit {
    ...
    ticketid_List: DropDownValues[];
    ticketid_optionsEvent: EventEmitter<any> = new EventEmitter<any>();//autocomplete
    actionuser_List: DropDownValues[];
    actionuser_optionsEvent: EventEmitter<any> = new EventEmitter<any>();//autocomplete
    ...
    onCopy() {
        ...
        if (this.formData.ticketdetailid != null) this.formData.ticketdetailid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.hlpticketdetail as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
        ...
        if (this.hlpticketdetail_Form.get('customfield').value != null && this.hlpticketdetail_Form.get('customfield').value != "") this.customFieldJson = JSON.parse(this.hlpticketdetail_Form.get('customfield').value);
        this.FillCustomField();
        if (this.hlpticketdetail_Form.get('attachment').value != null && this.hlpticketdetail_Form.get('attachment').value != "" && this.fileattachment != null && this.fileattachment != undefined) this.fileattachment.setattachmentlist(this.hlpticketdetail_Form.get('attachment').value);
        //Child Tables if any
    }
    ...
    async onSubmitData(bclear: any) {
        ...
        var customfields = this.customfieldservice.getCustomValues(document);
        if (this.hlpticketdetail_Form.get('assignedto').value != null) this.formData.assignedto = JSON.stringify(this.hlpticketdetail_Form.get('assignedto').value);
        ...
        this.spinner.show();
        this.hlpticketdetail_service.saveOrUpdate_hlpticketdetails(this.formData).subscribe(
            async res => {
                await this.sharedService.upload(this.fileAttachmentList);
                this.attachmentlist = [];
                if (this.fileattachment) this.fileattachment.clear();
                ...
                this.objvalues.push((res as any).hlpticketdetail);
