...
const routes: Routes = [
    {
        path: 'boreportothertables', children: [
            ...
            { path: 'view/:viewid', component: boreportothertableComponent, canDeactivate: [CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: boreportothertableComponent, canDeactivate: [CanDeactivateGuard] }
        ]
    }
];
