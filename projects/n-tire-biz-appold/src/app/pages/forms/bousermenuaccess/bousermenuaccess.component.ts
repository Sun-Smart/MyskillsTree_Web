...
export class bousermenuaccessComponent implements OnInit {
    ...
    bousermenuaccess_Form: FormGroup;
    ...
    constructor(
        ...
        private bousermenuaccess_service: bousermenuaccessService,
    ...
    onCopy() {
        ...
        if (this.formData.usermenuaccessid != null) this.formData.usermenuaccessid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.bousermenuaccess as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.bousermenuaccess_service.saveOrUpdate_bousermenuaccesses(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).bousermenuaccess);
