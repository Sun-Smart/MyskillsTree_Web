...
export class lmscampaigntaskresponseComponent implements OnInit {
    ...
    lmscampaigntaskresponse_Form: FormGroup;
    ...
    FillData(res: any) {
        ...
        if ((res.lmscampaigntaskresponse as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
        ...
        if (this.lmscampaigntaskresponse_Form.get('customfield').value != null && this.lmscampaigntaskresponse_Form.get('customfield').value != "") this.customFieldJson = JSON.parse(this.lmscampaigntaskresponse_Form.get('customfield').value);
        this.FillCustomField();
        if (this.lmscampaigntaskresponse_Form.get('attachment').value != null && this.lmscampaigntaskresponse_Form.get('attachment').value != "" && this.fileattachment != null && this.fileattachment != undefined) this.fileattachment.setattachmentlist(this.lmscampaigntaskresponse_Form.get('attachment').value);
        //Child Tables if any
    }
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.lmscampaigntaskresponse_service.saveOrUpdate_lmscampaigntaskresponses(this.formData).subscribe(
            async res => {
                await this.sharedService.upload(this.fileAttachmentList);
                this.attachmentlist = [];
                if (this.fileattachment) this.fileattachment.clear();
                ...
                this.objvalues.push((res as any).lmscampaigntaskresponse);
