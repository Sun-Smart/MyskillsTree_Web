...
const routes: Routes = [
    {
        path: 'lmsresponses', children: [
            ...
            { path: 'view/:viewid', component: lmsresponseComponent, canDeactivate: [CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: lmsresponseComponent, canDeactivate: [CanDeactivateGuard] }
        ]
    }
];
