...
export class crmcustomerservicedetailComponent implements OnInit {
    ...
    crmcustomerservicedetail_Form: FormGroup;
    ...
    constructor(
        ...
        private crmcustomerservicedetail_service: crmcustomerservicedetailService,
    ...
    onCopy() {
        ...
        if (this.formData.detailid != null) this.formData.detailid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.crmcustomerservicedetail as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        if (this.crmcustomerservicedetail_Form.get('notes').value != null) this.formData.notes = JSON.stringify(this.crmcustomerservicedetail_Form.get('notes').value);
        console.log(this.formData);
        this.spinner.show();
        this.crmcustomerservicedetail_service.saveOrUpdate_crmcustomerservicedetails(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).crmcustomerservicedetail);
