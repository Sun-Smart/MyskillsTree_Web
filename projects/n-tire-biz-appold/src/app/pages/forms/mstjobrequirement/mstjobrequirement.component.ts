...
export class mstjobrequirementComponent implements OnInit {
    ...
    FillData(res: any) {
        ...
        // console.log('res ',res.mstjobrequirement.locations);
        // console.log('res ',res.mstjobrequirement.skills);
        // console.log('res ',res.mstjobrequirement.education);
        // console.log('res ',res.mstjobrequirement.language);
