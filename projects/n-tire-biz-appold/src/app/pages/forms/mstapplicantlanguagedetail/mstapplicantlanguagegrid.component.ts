...
@Component({
    ...
    color: #fff !important;
    padding: 5px !important;">{{'Language Details'}}
  ...
  <thead>
    <tr>
      ...
      <th style="width: 10%;">Proficiency</th>
      <th style="width: 19%;">Rating</th>
      <th style="width: 24.5%;">Remarks</th>
      <th>Attachment</th>
            ...
            columns: {
                colhtml:
                {
                    ...
                    valuePrepareFunction: (cell, row) => {
                        ...
                        let showstr = "";
                        if (row.speakproficiency == '1' || row.readproficiency == '1' || row.writeproficiency == '1' || row.overallrating == '1') {
                            showstr = '★';
                        ...
                        divrow["speakproficiency"] = "<div class='Stars'  style='font-size: large !important;color:green;float: left;margin-left: 6%;'>" + showstr + "</div>";
                        divrow["readproficiency"] = "<div class='Stars' style='font-size: large !important;color:green;float: left;margin-left: 6%;'>" + showstr + "</div>";
                        divrow["writeproficiency"] = "<div class='Stars' style='font-size: large !important;color:green;float: left;margin-left: 6%;'>" + showstr + "</div>";
                        divrow["overallrating"] = "<div class='Stars' style='font-size: large !important;color:green;float: left;margin-left: 6%;'>" + showstr + "</div>";
