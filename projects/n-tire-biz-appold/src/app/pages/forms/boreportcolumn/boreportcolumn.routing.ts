...
const routes: Routes = [
    {
        path: 'boreportcolumns', children: [
            ...
            { path: 'view/:viewid', component: boreportcolumnComponent, canDeactivate: [CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: boreportcolumnComponent, canDeactivate: [CanDeactivateGuard] }
        ]
    }
];
