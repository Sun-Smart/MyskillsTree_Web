...
import { routing } from './mstapplicantreferencedetail.routing';
...
@NgModule({
  ...
  declarations: [mstapplicantreferencedetailComponent]
})
export class mstapplicantreferencedetailModule { }
