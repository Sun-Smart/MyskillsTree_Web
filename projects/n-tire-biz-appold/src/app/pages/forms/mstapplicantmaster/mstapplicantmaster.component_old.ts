...
export class mstapplicantmasterComponent implements OnInit {
    ...
    constructor(
        ...
        private mstapplicantmasterservice: mstapplicantmasterService,
    ...
    //navigation buttons
    first() {
        if (this.pkList.length > 0) this.PopulateScreen(this.editapplicantid);
    }
    ...
    prev() {
        ...
        if (pos > 0) this.PopulateScreen(this.editapplicantid);
    }

    next() {
        //debugger;;
        let pos = this.pkList.map(function (e: any) { return e.applicantid.toString(); }).indexOf(this.formid.toString());
        if (pos >= 0 && pos != this.pkList.length) this.PopulateScreen(this.editapplicantid);
    }

    //on searching in pk autocomplete
    onSelectedpk(pkDetail: any) {
        if (pkDetail.applicantid && pkDetail) {
            this.PopulateScreen(this.editapplicantid);
        }
    }
    ...
    async ngOnInit() {
      ...
      let abc=localStorage.getItem("resumeTabname")
      if(abc=="resumeTabupload"){
        ...
        debugger
        this.editapplicantid = this.sessionService.getItem("applicantid");
        var xyz = this.editapplicantid;
        let getTabname = localStorage.getItem('fullName');
        let getprofilename = localStorage.getItem('showprofile');
        let attachmentName = localStorage.getItem('attachmentTabname');
        if (getTabname == 'fullpage') {
            // localStorage.removeItem('showprofile');
            // localStorage.removeItem('attachmentTabname');
            this.hideDetailsbrief = true;
            this.attachmentshow = true;
            this.showProfilePage = true;
        } else if (attachmentName == 'attachmentTab') {
            // localStorage.removeItem('fullName');
            // localStorage.removeItem('showprofile');
            this.attachmentshow = true;
            this.showProfilePage = false;
            this.hideDetailsbrief = false;
        } else if (getprofilename == 'showprofile') {
            debugger
            // localStorage.removeItem('showprofile');
            this.hideDetailsbrief = true;
        ...
        if (this.pkcol == null) {
            ...
            if (this.maindata == undefined || this.maindata == null || this.maindata.save == true) await this.PopulateScreen(this.editapplicantid);
...
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##companyname## - ##designationdesc## ##isrelative##</h3>
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##mobilenumber## - ##email## ##knownduration##</h3>
<p style="margin: 0 auto !important;line-height: 2.0rem !important;">##remarks##</p>
</div>
`;
        return ret;
...
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##selfrating##</h3>
<p  style="margin: 0 auto !important;line-height: 2.0rem !important">##remarks##</p>
</div>
`;
        return ret;
...
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'><a href='##url##' target='_blank'>##url##</a></h3>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##remarks##</p>
</div>
`;
        return ret;
...
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##achievementdetails##</h3>
</div>
`;
        return ret;
    }
...
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>Read ##readproficiency## Write ##writeproficiency## Speak: ##speakproficiency##</h3>
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##mobilenumber## - ##email## ##knownduration##</h3>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##remarks##</p>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##attachment##</p>
</div>
`;
        return ret;
    }
...
`;
    ...
    mstjobstatuseshtml() {
        let ret = "";
        ret += `<div class='card1'  style='display:block'>
<h2 style="margin: 0 auto !important;">##corporateiddesc##</h2>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##comments##</p>
</div>
`;
        return ret;
    }
...
<h2 style="margin: 0 auto !important;">##requestmasterdatatypeiddesc## - ##requestmasteriddesc##</h2>
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##requestreferencedate## - ##requestedcontactdesc## - ##contactuseriddesc## - ##contactdesignationdesc##</h3>
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##contactmobile## - ##contactemailid##  </h3>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##requestremarks##</p>
<h3 style="margin: 0 auto !important;" class='profile__section__item__sub'>##referencedate## - ##referenceacceptance## ##contactfileattach##</h3>
<p style="margin: 0 auto !important;line-height: 2.0rem !important">##referenceremarks##</p>
<p style="margin: 0 auto !important;">##attachment##</p>
</div>
`;
        return ret;
    }
    ...
    async PopulateScreen(xyz: any) {
        debugger
        this.spinner.show();
        this.mstapplicantmaster_service.get_mstapplicantmasters_ByEID(xyz).then(res => {
            debugger
            this.spinner.hide();
    ...
    async onSubmitData(bclear: any) {
        ...
        console.log('below formdata', this.formData);
        this.spinner.show();
        ...
        this.mstapplicantmaster_service.saveOrUpdate_mstapplicantmasters(this.formData).subscribe(
            async res => {
                debugger
                await this.sharedService.upload(this.profilephoto.getAllFiles());
                await this.sharedService.upload(this.fileAttachmentList);
                ...
                this.router.navigate(['/home/mstapplicantmasters/mstapplicantmasters/view/' + this.editapplicantid]);
    ...
    mstapplicanteducationdetails_route(event: any, action: any) {
        ...
        switch (action) {
            ...
            case 'edit':
                ...
                break;
            case 'delete':
                console.log('delete check ', event.data.educationid);
