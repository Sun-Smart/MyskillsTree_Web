...
import { routing } from './lmscorporatesecondarycontact.routing';
...
@NgModule({
  ...
  declarations: [lmscorporatesecondarycontactComponent]
})
export class lmscorporatesecondarycontactModule { }
