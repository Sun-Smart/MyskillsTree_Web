  ...
  `],
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
            Category <br/><select  id="category" formControlName="category" class="form-control">
            ...
            <div *ngIf="attachmentForm.controls['category'].invalid && attachmentForm.controls['category'].touched" class="alert alert-danger">
            ...
            <div>
              Description
            <br/> <input  id="description" formControlName="description" class="form-control" placeholder="Enter attachment description">
            <div *ngIf="attachmentForm.controls['description'].invalid && attachmentForm.controls['description'].touched" class="alert alert-danger">
            ...
            <div class="col">
            URL <br/><input  id="url" formControlName="url" class="form-control">
            <div *ngIf="attachmentForm.controls['url'].invalid && attachmentForm.controls['url'].touched" class="alert alert-danger">
            <div *ngIf="attachmentForm.controls['url'].errors.required">
            Url is required.
          </div>
        </div>
            </div>
            <div>
            Select <br/><input type="file" style="margin-top: 8px;" formControlName="ImageName"  appImgCompressor  [uploader]="uploader" multiple  (onFileSelected)="onFileSelected($event)" class="" />
            </div>
            <div class="col">
            <a [routerLink]='' (click)="test(attachmentForm)"><i style="color:black !important; font-size: 20px; position: absolute;
...
export class AttachmentComponent implements ControlValueAccessor {
    ...
    constructor(private fb: FormBuilder, private sharedService: SharedService, public dialog: DialogService) {
        ////debugger;
