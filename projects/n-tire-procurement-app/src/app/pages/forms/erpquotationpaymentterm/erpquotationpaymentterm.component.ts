import { erpquotationpaymenttermService } from './../../../service/erpquotationpaymentterm.service';
...
@Component({
selector: 'app-erpquotationpaymentterm',
...
private erpquotationpaymenttermservice: erpquotationpaymenttermService,
...
debugger;
if (this.erpquotationpaymenttermForm.dirty && this.erpquotationpaymenttermForm.touched ) {
...
let erpquotationpaymenttermid = null;
...
this.formid=erpquotationpaymenttermid;
//this.sharedService.alert(erpquotationpaymenttermid);
...
if(this.erpquotationpaymenttermservice.formData && this.erpquotationpaymenttermservice.formData.supplierid){
this.supplieridoptionsEvent.emit(this.supplieridList);
this.erpquotationpaymenttermForm.patchValue({
    supplierid: this.erpquotationpaymenttermservice.formData.supplierid,
    supplieriddesc: this.erpquotationpaymenttermservice.formData.supplieriddesc,
});
}
{
let arrsupplierid = this.supplieridList.filter(v => v.supplierid == this.erpquotationpaymenttermForm.get('supplierid').value);
let objsupplierid;
...
if(this.erpquotationpaymenttermservice.formData && this.erpquotationpaymenttermservice.formData.rfqid){
this.rfqidoptionsEvent.emit(this.rfqidList);
this.erpquotationpaymenttermForm.patchValue({
    rfqid: this.erpquotationpaymenttermservice.formData.rfqid,
    rfqiddesc: this.erpquotationpaymenttermservice.formData.rfqiddesc,
});
}
{
let arrrfqid = this.rfqidList.filter(v => v.rfqid == this.erpquotationpaymenttermForm.get('rfqid').value);
let objrfqid;
...
if(this.erpquotationpaymenttermservice.formData && this.erpquotationpaymenttermservice.formData.quoteid){
this.quoteidoptionsEvent.emit(this.quoteidList);
this.erpquotationpaymenttermForm.patchValue({
    quoteid: this.erpquotationpaymenttermservice.formData.quoteid,
    quoteiddesc: this.erpquotationpaymenttermservice.formData.quoteiddesc,
});
}
{
let arrquoteid = this.quoteidList.filter(v => v.quotationid == this.erpquotationpaymenttermForm.get('quoteid').value);
let objquoteid;
...
//autocomplete
    this.erpquotationpaymenttermservice.geterpquotationpaymenttermsList().then(res => {
      this.pkList = res as erpquotationpaymentterm[];
...
this.erpquotationpaymenttermForm.markAsUntouched();
this.erpquotationpaymenttermForm.markAsPristine();
}
...
resetForm() {
if (this.erpquotationpaymenttermForm != null)
this.erpquotationpaymenttermForm.reset();
this.erpquotationpaymenttermForm.patchValue({
});
this.PopulateFromMainScreen(this.data,false);
this.PopulateFromMainScreen(this.dynamicconfig.data,true);
    ...
    onDelete() {
        let paytermid = this.erpquotationpaymenttermForm.get('paytermid').value;
        if(paytermid!=null)
        {
        if (confirm('Are you sure to delete this record ?')) {
            this.erpquotationpaymenttermservice.deleteerpquotationpaymentterm(paytermid).then(res =>
                {
                this.resetForm();
                }
            ).catch((err) => {console.log(err);});
    ...
    if(this.erpquotationpaymenttermservice.formData.paytermid!=null)this.erpquotationpaymenttermservice.formData.paytermid=null;
    }
...
{
this.erpquotationpaymenttermForm.patchValue({[key]:  mainscreendata[key] } );
}
        else
{
this.erpquotationpaymenttermForm.patchValue({[key]:  mainscreendata[key] } );
...
{
{
         if(bdisable && this.erpquotationpaymenttermForm.controls[key]!=undefined)
{
this.erpquotationpaymenttermForm.controls[key].disable({onlySelf: true});
...
this.erpquotationpaymenttermservice.geterpquotationpaymenttermsByEID(pkcol).then(res => {

this.erpquotationpaymenttermservice.formData=res.erpquotationpaymentterm;
let formproperty=res.erpquotationpaymentterm.formproperty;
if(formproperty && formproperty.edit==false)this.showview=true;
this.pkcol=res.erpquotationpaymentterm.pkcol;
this.formid=res.erpquotationpaymentterm.paytermid;
this.FillData(res);
}).catch((err) => {console.log(err);});
}
...
this.erpquotationpaymenttermForm.patchValue({
supplierid: res.erpquotationpaymentterm.supplierid,
supplieriddesc: res.erpquotationpaymentterm.supplieriddesc,
rfqid: res.erpquotationpaymentterm.rfqid,
rfqiddesc: res.erpquotationpaymentterm.rfqiddesc,
quoteid: res.erpquotationpaymentterm.quoteid,
quoteiddesc: res.erpquotationpaymentterm.quoteiddesc,
paytermid: res.erpquotationpaymentterm.paytermid,
paymenttermtype: res.erpquotationpaymentterm.paymenttermtype,
paymenttermtypedesc: res.erpquotationpaymentterm.paymenttermtypedesc,
percentage: res.erpquotationpaymentterm.percentage,
description: res.erpquotationpaymentterm.description,
amount: res.erpquotationpaymentterm.amount,
status: res.erpquotationpaymentterm.status,
statusdesc: res.erpquotationpaymentterm.statusdesc,
});
//Child Tables if any
}
...
getHtml(html:any)
{
  let ret = "";
  ret = html;
  for (let key in this.erpquotationpaymenttermForm.controls) {
    if (this.erpquotationpaymenttermForm.controls[key] != null) {
if(false)
{
if(this.erpquotationpaymenttermservice.formData!=null && this.erpquotationpaymenttermservice.formData[key]!=null  && this.erpquotationpaymenttermservice.formData[key]!='[]' && this.erpquotationpaymenttermservice.formData[key]!=undefined && this.erpquotationpaymenttermservice.formData[key].length>0)ret = ret.replace(new RegExp('##' + key + '##', 'g'),"http://localhost:5002/"+ JSON.parse(this.erpquotationpaymenttermservice.formData[key])[0]["name"]);
}
else if(false)
{
if(this.erpquotationpaymenttermservice.formData!=null && this.erpquotationpaymenttermservice.formData[key]!=null   && this.erpquotationpaymenttermservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='Stars' style='--rating:"+ this.erpquotationpaymenttermservice.formData[key]+"></div>");
}
else if(false)
{
if(this.erpquotationpaymenttermservice.formData!=null && this.erpquotationpaymenttermservice.formData[key]!=null   && this.erpquotationpaymenttermservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='progress--circle progress--"+this.erpquotationpaymenttermservice.formData[key]+"'><div class='progress__number'>"+this.erpquotationpaymenttermservice.formData[key]+"%</div></div>");
}
else
      ret = ret.replace(new RegExp('##' + key + '##', 'g'), this.erpquotationpaymenttermForm.controls[key].value);
    }
  }
  return ret;
}
...
this.isSubmitted = true;
let strError="";
Object.keys(this.erpquotationpaymenttermForm.controls).forEach(key => {
    const controlErrors: ValidationErrors = this.erpquotationpaymenttermForm.get(key).errors;
...
this.erpquotationpaymenttermservice.formData=this.erpquotationpaymenttermForm.value;
...
if(key!='visiblelist' && key!='hidelist'){
    if (this.erpquotationpaymenttermForm.controls[key] != null)
    {
        this.erpquotationpaymenttermservice.formData[key] = this.erpquotationpaymenttermForm.controls[key].value;
    }
}
}
}
console.log(this.erpquotationpaymenttermservice.formData);
this.erpquotationpaymenttermservice.formData=this.erpquotationpaymenttermForm.value;
this.erpquotationpaymenttermservice.saveOrUpdateerpquotationpaymentterms().subscribe(
async res => {
debugger;
...
{
this.dialogRef.close((res as any).erpquotationpaymentterm);
    return;
}
else
{
...
this.erpquotationpaymenttermservice.clearList();
if(bclear){
this.resetForm();
}
else{
...
{
data: {supplierid:this.erpquotationpaymenttermForm.get('supplierid').value, ScreenType:2 }
} 
...
{
data: {rfqid:this.erpquotationpaymenttermForm.get('rfqid').value, ScreenType:2 }
} 
).onClose.subscribe(res => {
});*/
}
...
{
data: {quotationid:this.erpquotationpaymenttermForm.get('quoteid').value, ScreenType:2 }
} 
).onClose.subscribe(res => {
});*/
}
