...
import { boteamComponent } from '../../../../../../n-tire-bo-app/src/app/pages/forms/boteam/boteam.component';
...
import { ecmspecialComponent } from '../../../../../../n-tire-commerce-app/src/app/pages/forms/ecmspecial/ecmspecial.component';
//FK services
import { erpproductattribute } from './../../../model/erpproductattribute.model';
import { erpproductattributeComponent } from './../../../pages/forms/erpproductattribute/erpproductattribute.component';
//FK services
...
import { ltymerchantproductComponent } from '../../../../../../n-tire-loyalty-app/src/app/pages/forms/ltymerchantproduct/ltymerchantproduct.component';
//FK services
import { ltymerchant,IltymerchantResponse } from '../../../../../../n-tire-loyalty-app/src/app/model/ltymerchant.model';
import { ltymerchantComponent } from '../../../../../../n-tire-loyalty-app/src/app/pages/forms/ltymerchant/ltymerchant.component';
import { ltymerchantService } from '../../../../../../n-tire-loyalty-app/src/app/service/ltymerchant.service';
import { erpproductpricehistory } from './../../../model/erpproductpricehistory.model';
import { erpproductpricehistoryComponent } from './../../../pages/forms/erpproductpricehistory/erpproductpricehistory.component';
//FK services
...
import { erpproductfeatureparameterComponent } from './../../../pages/forms/erpproductfeatureparameter/erpproductfeatureparameter.component';
//FK services
import { bodynamicform,IbodynamicformResponse } from '../../../../../../n-tire-bo-app/src/app/model/bodynamicform.model';
...
import { erpproductaccessComponent } from './../../../pages/forms/erpproductaccess/erpproductaccess.component';
//FK services
...
import { erpproductimageComponent } from './../../../pages/forms/erpproductimage/erpproductimage.component';
//FK services
...
dataerpproductpricehistoriesproductid3:any=[];
...
dataerpproductimagesproductid3:any=[];
...
erpproductshowOption:boolean;
ecmspecialshowOption:boolean;
erpproductattributeshowOption:boolean;
ltymerchantproductshowOption:boolean;
erpproductpricehistoryshowOption:boolean;
ecmcustomerbasketshowOption:boolean;
erpproductfeatureparametershowOption:boolean;
ecmreviewshowOption:boolean;
erpproductaccessshowOption:boolean;
erpproductimageshowOption:boolean;
sessiondata:any;
sourcekey:any;
...
this.erpproductForm  = this.fb.group({
pk:[null],
ImageName: [null],
productid: [null],
productcode: [null],
...
if (marketingmanageridDetail.userid && marketingmanageridDetail) {
this.erpproductForm.patchValue({
marketingmanagerid: marketingmanageridDetail.userid,
...
if (salesmanageridDetail.userid && salesmanageridDetail) {
this.erpproductForm.patchValue({
salesmanagerid: salesmanageridDetail.userid,
...
if (supportmanageridDetail.userid && supportmanageridDetail) {
this.erpproductForm.patchValue({
supportmanagerid: supportmanageridDetail.userid,
...
if (salesteamDetail.teamid && salesteamDetail) {
this.erpproductForm.patchValue({
salesteam: salesteamDetail.teamid,
...
if (preferredsupplierDetail.supplierid && preferredsupplierDetail) {
this.erpproductForm.patchValue({
preferredsupplier: preferredsupplierDetail.supplierid,
preferredsupplierdesc: preferredsupplierDetail.suppliercode,

});
this.erpsupplieritemservice.getListBysupplierid(preferredsupplierDetail.supplierid).then(res => {
 this.preferredproductList = res as erpsupplieritem[]
}).catch((err) => {console.log(err);});
...
if (salesaccountDetail.accountid && salesaccountDetail) {
this.erpproductForm.patchValue({
salesaccount: salesaccountDetail.accountid,
...
if (purchaseaccountDetail.accountid && purchaseaccountDetail) {
this.erpproductForm.patchValue({
purchaseaccount: purchaseaccountDetail.accountid,
...
if (competitorproductadditionowneridDetail.userid && competitorproductadditionowneridDetail) {
this.erpproductForm.patchValue({
competitorproductadditionownerid: competitorproductadditionowneridDetail.userid,
...
if (marketresearchowneridDetail.userid && marketresearchowneridDetail) {
this.erpproductForm.patchValue({
marketresearchownerid: marketresearchowneridDetail.userid,
...
if (marketsegmentationowneridDetail.userid && marketsegmentationowneridDetail) {
this.erpproductForm.patchValue({
marketsegmentationownerid: marketsegmentationowneridDetail.userid,
...
if (competitiveanalysisowneridDetail.userid && competitiveanalysisowneridDetail) {
this.erpproductForm.patchValue({
competitiveanalysisownerid: competitiveanalysisowneridDetail.userid,
...
if (competitivepositioningstrategyowneridDetail.userid && competitivepositioningstrategyowneridDetail) {
this.erpproductForm.patchValue({
competitivepositioningstrategyownerid: competitivepositioningstrategyowneridDetail.userid,
...
{
{
         if(bdisable && this.erpproductForm.controls[key]!=undefined)
{
this.erpproductForm.controls[key].disable({onlySelf: true});
...
onSubmitAndWait() {
if(this.maindata==undefined || this.maindata.save==true  || this.erpproductservice.formData.productname!=null )
{
...
this.erpproductservice.formData=res.erpproduct;
let formproperty=res.erpproduct.formproperty;
if(formproperty && formproperty.edit==false)this.showview=true;
this.pkcol=res.erpproduct.pkcol;
...
productimage: JSON.parse(res.erpproduct.productimage),
...
attachment: JSON.parse(res.erpproduct.attachment),
...
this.FillCustomField();
if(this.erpproductForm.get('productimage').value!=null && this.erpproductForm.get('productimage').value!="" && this.productimage!=null && this.productimage!=undefined)this.productimage.setattachmentlist(this.erpproductForm.get('productimage').value);
if(this.erpproductForm.get('attachment').value!=null && this.erpproductForm.get('attachment').value!="" && this.fileattachment!=null && this.fileattachment!=undefined)this.fileattachment.setattachmentlist(this.erpproductForm.get('attachment').value);
setTimeout(() => {
if(this.f.preferredsupplier.value && this.f.preferredsupplier.value!="" && this.f.preferredsupplier.value!=null)this.erpsupplieritemservice.getListBysupplierid(this.f.preferredsupplier.value).then(res =>{
this.preferredproductList = res as erpsupplieritem[];
}).catch((err) => {console.log(err);});
...
if( key=="productimage")
{
if(this.erpproductservice.formData!=null && this.erpproductservice.formData[key]!=null  && this.erpproductservice.formData[key]!='[]' && this.erpproductservice.formData[key]!=undefined && this.erpproductservice.formData[key].length>0)ret = ret.replace(new RegExp('##' + key + '##', 'g'),"http://localhost:5002/"+ JSON.parse(this.erpproductservice.formData[key])[0]["name"]);
}
else if(false)
{
if(this.erpproductservice.formData!=null && this.erpproductservice.formData[key]!=null   && this.erpproductservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='Stars' style='--rating:"+ this.erpproductservice.formData[key]+"></div>");
}
else if(false)
{
if(this.erpproductservice.formData!=null && this.erpproductservice.formData[key]!=null   && this.erpproductservice.formData[key]!=undefined )ret = ret.replace(new RegExp('##' + key + '##', 'g'),"<div class='progress--circle progress--"+this.erpproductservice.formData[key]+"'><div class='progress__number'>"+this.erpproductservice.formData[key]+"%</div></div>");
}
else
...
if(this.erpproductForm.get('metadata').value!=null)obj.metadata=JSON.stringify(this.erpproductForm.get('metadata').value);
...
private erpproducttoggleOption(){
this.erpproductshowOption = this.erpproductshowOption === true ? false : true;
}

private ecmspecialtoggleOption(){
this.ecmspecialshowOption = this.ecmspecialshowOption === true ? false : true;
}
...
private ltymerchantproducttoggleOption(){
this.ltymerchantproductshowOption = this.ltymerchantproductshowOption === true ? false : true;
}

private erpproductpricehistorytoggleOption(){
this.erpproductpricehistoryshowOption = this.erpproductpricehistoryshowOption === true ? false : true;
}
...
private erpproductfeatureparametertoggleOption(){
this.erpproductfeatureparametershowOption = this.erpproductfeatureparametershowOption === true ? false : true;
}
...
private erpproductimagetoggleOption(){
this.erpproductimageshowOption = this.erpproductimageshowOption === true ? false : true;
}
...
if(this.erpproductForm.get('metadata').value!=null)this.erpproductservice.formData.metadata=JSON.stringify(this.erpproductForm.get('metadata').value);
this.erpproductservice.formData.productimage=this.erpproductForm.get('productimage').value;
if(customfields!=null)this.erpproductservice.formData.customfield=JSON.stringify(customfields);
if(this.fileattachment.getattachmentlist()!=null)this.erpproductservice.formData.attachment=JSON.stringify(this.fileattachment.getattachmentlist());
...
if(this.productimage.getattachmentlist()!=null)this.erpproductservice.formData.productimage=JSON.stringify(this.productimage.getattachmentlist());
...
{
this.dialogRef.close((res as any).erpproduct);
    return;
}
else
{
...
AddOrEditecmspecial(event:any,specialid:any, productid:any) {
let add=false;
if(event==null)add=true;
this.dialog.open(ecmspecialComponent, 
{
data:  {  showview:false,save:false,event,specialid, productid,visiblelist:this.ecmspecialsvisiblelist,  hidelist:this.ecmspecialshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
if(add)
{
this.ecmspecialssource.add(res);
this.ecmspecialssource.refresh();
}
else
{
this.ecmspecialssource.update(event.data, res);
}
}
});
}
...
AddOrEditerpproductattribute(event:any,productattributeid:any, productid:any) {
let add=false;
if(event==null)add=true;
this.dialog.open(erpproductattributeComponent, 
{
data:  {  showview:false,save:false,event,productattributeid, productid,visiblelist:this.erpproductattributesvisiblelist,  hidelist:this.erpproductattributeshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
if(add)
{
this.erpproductattributessource.add(res);
this.erpproductattributessource.refresh();
}
else
{
this.erpproductattributessource.update(event.data, res);
}
}
});
}
...
AddOrEditltymerchantproduct(event:any,merchantproductid:any, productid:any) {
let add=false;
if(event==null)add=true;
this.dialog.open(ltymerchantproductComponent, 
{
data:  {  showview:false,save:false,event,merchantproductid, productid,visiblelist:this.ltymerchantproductsvisiblelist,  hidelist:this.ltymerchantproductshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
{
data:  {  showview:false,save:false,event,priceid, productid,visiblelist:this.erpproductpricehistoriesvisiblelist,  hidelist:this.erpproductpricehistorieshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
{
data:  {  showview:false,save:false,event,customersbasketid, productid,visiblelist:this.ecmcustomerbasketsvisiblelist,  hidelist:this.ecmcustomerbasketshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
{
data:  {  showview:false,save:false,event,epfpid, productid,visiblelist:this.erpproductfeatureparametersvisiblelist,  hidelist:this.erpproductfeatureparametershidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
{
data:  {  showview:false,save:false,event,reviewid, productid,visiblelist:this.ecmreviewsvisiblelist,  hidelist:this.ecmreviewshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
{
data:  {  showview:false,save:false,event,imageid, productid,visiblelist:this.erpproductimagesvisiblelist,  hidelist:this.erpproductimageshidelist,ScreenType:2  },
} 
).onClose.subscribe(res => {
if(res)
{
...
switch ( action) {
case 'create':
this.AddOrEditecmspecial(event,null, this.formid);
break;
case 'view':
break;
case 'edit':
this.AddOrEditecmspecial(event,event.data.specialid,this.formid);
break;
case 'delete':
this.onDeleteecmspecial(event,event.data.specialid,((this.ecmspecialssource.getPaging().page-1) *this.ecmspecialssource.getPaging().perPage)+event.index);
this.ecmspecialssource.refresh();
break;
}
}
ecmspecialsonDelete(obj) {
let specialid=obj.data.specialid;
if (confirm('Are you sure to delete this record ?')) {
this.erpproductservice.deleteerpproduct(specialid).then(res=>
this.ecmspecialsLoadTable()
);
}
}
...
switch ( action) {
case 'create':
this.AddOrEditerpproductattribute(event,null, this.formid);
break;
case 'view':
break;
case 'edit':
this.AddOrEditerpproductattribute(event,event.data.productattributeid,this.formid);
break;
case 'delete':
this.onDeleteerpproductattribute(event,event.data.productattributeid,((this.erpproductattributessource.getPaging().page-1) *this.erpproductattributessource.getPaging().perPage)+event.index);
this.erpproductattributessource.refresh();
break;
}
}
erpproductattributesonDelete(obj) {
let productattributeid=obj.data.productattributeid;
if (confirm('Are you sure to delete this record ?')) {
this.erpproductservice.deleteerpproduct(productattributeid).then(res=>
this.erpproductattributesLoadTable()
);
}
}
...
if (confirm('Are you sure to delete this record ?')) {
this.erpproductservice.deleteerpproduct(merchantproductid).then(res=>
this.ltymerchantproductsLoadTable()
);
}
}
