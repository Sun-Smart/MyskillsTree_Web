...
{
data:  {  showview:false,save:false,event,taskid, visiblelist:this.prjprojecttasksvisiblelist,  hidelist:this.prjprojecttaskshidelist,ScreenType:2,deliverableid:this.prjprojectdeliverableForm.get('deliverableid').value  },
} 
