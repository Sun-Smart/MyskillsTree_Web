...
export class boworkflowstepComponent implements OnInit {
    ...
    async onSubmitDataDlg(bclear: any) {
        ...
        if (this.boworkflowstep_Form.get('approver').value != null) obj.approver = JSON.stringify(this.boworkflowstep_Form.get('approver').value);
        if (this.boworkflowstep_Form.get('escalationuser').value != null) obj.escalationuser = JSON.stringify(this.boworkflowstep_Form.get('escalationuser').value);
        if (this.boworkflowstep_Form.get('cc').value != null) obj.cc = JSON.stringify(this.boworkflowstep_Form.get('cc').value);
        console.log(obj);
    ...
    async onSubmitData(bclear: any) {
        ...
        if (this.boworkflowstep_Form.get('approver').value != null) this.formData.approver = JSON.stringify(this.boworkflowstep_Form.get('approver').value);
        if (this.boworkflowstep_Form.get('escalationuser').value != null) this.formData.escalationuser = JSON.stringify(this.boworkflowstep_Form.get('escalationuser').value);
        if (this.boworkflowstep_Form.get('cc').value != null) this.formData.cc = JSON.stringify(this.boworkflowstep_Form.get('cc').value);
        console.log(this.formData);
        this.spinner.show();
        this.boworkflowstep_service.saveOrUpdate_boworkflowsteps(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
