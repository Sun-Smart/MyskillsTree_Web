...
export class crmindexdetailComponent implements OnInit {
    ...
    constructor(
        ...
        private crmindexdetail_service: crmindexdetailService,
    ...
    onCopy() {
        ...
        if (this.formData.indexdetailid != null) this.formData.indexdetailid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.crmindexdetail as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.crmindexdetail_service.saveOrUpdate_crmindexdetails(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).crmindexdetail);
