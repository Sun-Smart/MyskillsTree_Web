...
export class lmsquotepaymenttermComponent implements OnInit {
    ...
    lmsquotepaymentterm_Form: FormGroup;

    opportunityid_List: DropDownValues[];
    opportunityid_optionsEvent: EventEmitter<any> = new EventEmitter<any>();//autocomplete
    quoteid_List: DropDownValues[];
    quoteid_optionsEvent: EventEmitter<any> = new EventEmitter<any>();//autocomplete
    duedate_List: DropDownValues[];
    ...
    onSelected_quoteid(quoteidDetail: any) {
    ...
    onCopy() {
        ...
        if (this.formData.paymenttermid != null) this.formData.paymenttermid = null;
    }
    ...
    quoteid_onChange(evt: any) {
        let e = evt.value;
    }
    duedate_onChange(evt: any) {
    ...
    FillData(res: any) {
        ...
        if ((res.lmsquotepaymentterm as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        this.lmsquotepaymentterm_Form.patchValue({
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.lmsquotepaymentterm_service.saveOrUpdate_lmsquotepaymentterms(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).lmsquotepaymentterm);
