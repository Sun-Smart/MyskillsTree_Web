...
const routes: Routes = [
    {
        path: 'boreportdetails', children: [
            ...
            { path: 'view/:viewid', component: boreportdetailComponent, canDeactivate: [CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: boreportdetailComponent, canDeactivate: [CanDeactivateGuard] }
        ]
    }
];
