...
export class lmsopportunityproductComponent implements OnInit {
    ...
    lmsopportunityproduct_Form: FormGroup;
    ...
    onCopy() {
        ...
        if (this.formData.opportunityproductid != null) this.formData.opportunityproductid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.lmsopportunityproduct as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.lmsopportunityproduct_service.saveOrUpdate_lmsopportunityproducts(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).lmsopportunityproduct);
