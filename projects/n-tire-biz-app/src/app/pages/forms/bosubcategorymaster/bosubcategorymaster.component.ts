...
export class bosubcategorymasterComponent implements OnInit {
    ...
    async onSubmitData(bclear: any) {
        ...
        this.isSubmitted = true;
        let strError = "";
        // Object.keys(this.bosubcategorymaster_Form.controls).forEach(key => {
        //     const controlErrors: ValidationErrors = this.bosubcategorymaster_Form.get(key).errors;
