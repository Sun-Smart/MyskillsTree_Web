...
@Component({
    ...
    templateUrl: './mstterm.component.html',
    styles: [],
...
export class msttermComponent implements OnInit {
    formData: mstterm;
    list: mstterm[];
    ...
    bfilterPopulate_mstterms: boolean = false;
    mstterm_menuactions: any = []
    ...
    constructor(
        ...
        private mstterm_service: msttermService,
    ...
    async onSubmitData(bclear: any) {
        ...
        this.mstterm_service.saveOrUpdate_mstterms(this.formData).subscribe(
            async res => {
                ...
                this.objvalues.push((res as any).mstterm);
