...
export class systemtabletemplateComponent implements OnInit {
    ...
    systemtabletemplate_Form: FormGroup;
    ...
    get f() { return this.systemtabletemplate_Form.controls; }
    ...
    onSelectedpk(pkDetail: any) {
        if (pkDetail.tabledetailid && pkDetail) {
    ...
    async ngOnInit() {
        ...
        let systemtabletemplateid = null;
        ...
        this.formid = systemtabletemplateid;
        //alert(systemtabletemplateid);
    ...
    resetForm() {
        if (this.systemtabletemplate_Form != null)
            this.systemtabletemplate_Form.reset();
    ...
    onDelete() {
        let tabledetailid = this.systemtabletemplate_Form.get('tabledetailid').value;
    ...
    onCopy() {
        ...
        if (this.formData.tabledetailid != null) this.formData.tabledetailid = null;
    }
            ...
            for (let key in mainscreendata) {
                if (key != 'visiblelist' && key != 'hidelist' && key != 'event') {
                    ...
                    if (false)
                        ...
                        this.systemtabletemplate_Form.patchValue({ [key]: mainscreendata[key] });
                    }
                    else {
                        this.systemtabletemplate_Form.patchValue({ [key]: mainscreendata[key] });
                    }
                    {
                        {
                            if (bdisable && this.systemtabletemplate_Form.controls[key] != undefined) {
                                this.systemtabletemplate_Form.controls[key].disable({ onlySelf: true });
    ...
    userroleid_onChange(evt: any) {
        let e = evt.value;
        this.systemtabletemplate_Form.patchValue({ userroleiddesc: evt.options[evt.options.selectedIndex].text });
    }
    ...
    async PopulateScreen(pkcol: any) {
        this.spinner.show();
        this.systemtabletemplate_service.get_systemtabletemplates_ByEID(pkcol).then(res => {
            this.spinner.hide();

            this.formData = res.systemtabletemplate;
            let formproperty = res.systemtabletemplate.formproperty;
    ...
    FillData(res: any) {
        ...
        this.systemtabletemplate_Form.patchValue({
            ...
            userroleid: res.systemtabletemplate.userroleid,
            userroleiddesc: res.systemtabletemplate.userroleiddesc,
            viewhtml: res.systemtabletemplate.viewhtml,
            templatehtml: res.systemtabletemplate.templatehtml,
            visiblefields: res.systemtabletemplate.visiblefields,
            hidefields: res.systemtabletemplate.hidefields,
            status: res.systemtabletemplate.status,
            statusdesc: res.systemtabletemplate.statusdesc,
        });
    ...
    getHtml(html: any) {
        let ret = "";
        ret = html;
        for (let key in this.systemtabletemplate_Form.controls) {
            let val = this.systemtabletemplate_Form.controls[key].value;
            if (val == 'null' || val == null || val == undefined) val = '';
            if (this.systemtabletemplate_Form.controls[key] != null) {
                if (false) {
    ...
    async onSubmitData(bclear: any) {
        ...
        this.formData = this.systemtabletemplate_Form.getRawValue();
        if (this.dynamicconfig.data != null) {
            for (let key in this.dynamicconfig.data) {
                if (key != 'visiblelist' && key != 'hidelist') {
                    if (this.systemtabletemplate_Form.controls[key] != null) {
                        this.formData[key] = this.systemtabletemplate_Form.controls[key].value;
                    }
                }
            }
        }
