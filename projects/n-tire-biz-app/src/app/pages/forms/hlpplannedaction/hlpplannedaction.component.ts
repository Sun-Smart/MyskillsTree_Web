...
export class hlpplannedactionComponent implements OnInit {
    ...
    hlpplannedaction_Form: FormGroup;
    ...
    onCopy() {
        ...
        if (this.formData.planid != null) this.formData.planid = null;
    }
    ...
    FillData(res: any) {
        ...
        if ((res.hlpplannedaction as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.hlpplannedaction_service.saveOrUpdate_hlpplannedactions(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).hlpplannedaction);
