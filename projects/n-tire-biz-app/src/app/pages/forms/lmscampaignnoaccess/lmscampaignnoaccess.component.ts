...
export class lmscampaignnoaccessComponent implements OnInit {
    ...
    lmscampaignnoaccess_Form: FormGroup;
    ...
    constructor(
        ...
        private lmscampaignnoaccess_service: lmscampaignnoaccessService,
    ...
    FillData(res: any) {
        ...
        if ((res.lmscampaignnoaccess as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        console.log(res);
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.lmscampaignnoaccess_service.saveOrUpdate_lmscampaignnoaccesses(this.formData).subscribe(
            async res => {
                this.spinner.hide();
                debugger;
                this.toastr.addSingle("success", "", "Successfully saved");
                this.objvalues.push((res as any).lmscampaignnoaccess);
