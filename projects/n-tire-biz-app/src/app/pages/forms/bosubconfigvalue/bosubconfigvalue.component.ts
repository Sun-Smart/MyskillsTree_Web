...
export class bosubconfigvalueComponent implements OnInit {
    ...
    bosubconfigvalue_Form: FormGroup;

    configkey_List: DropDownValues[];
    subconfigcode_List: DropDownValues[];
    ...
    subconfigcode_onChange(evt: any) {
    ...
    FillData(res: any) {
        ...
        if ((res.bosubconfigvalue as any).applicantid == this.sessionService.getItem('applicantid')) this.bmyrecord = true;
        this.bosubconfigvalue_Form.patchValue({
    ...
    async onSubmitData(bclear: any) {
        ...
        this.spinner.show();
        this.bosubconfigvalue_service.saveOrUpdate_bosubconfigvalues(this.formData).subscribe(
            async res => {
                this.spinner.hide();
