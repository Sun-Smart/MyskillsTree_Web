...
const routes: Routes = [
    {
        path: 'lmsmasters', children: [
            ...
            { path: 'view/:viewid', component: lmsmasterComponent, canDeactivate: [CanDeactivateGuard] },
            { path: 'edit/:id/source/:sourcekey/:sourceid', component: lmsmasterComponent, canDeactivate: [CanDeactivateGuard] }
        ]
    }
];
