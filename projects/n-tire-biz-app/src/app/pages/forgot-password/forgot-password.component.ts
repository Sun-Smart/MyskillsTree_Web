...
<!-- <div  style="text-align: right; " *ngIf="sent" >
  ...
  style=" width: 150px !important;" /></a></h1> -->
   ...
   <!-- <a *ngIf="sent" style="text-align: right;" id='forgotBox' class="" [routerLink]='' (click)="onClose()"><i class="fa fa-times-circle close_common_icon"></i></a> -->

  <div class="row">
    <!-- <div class="col-xs-12">
      <p *ngIf="sent" class="this.sharedService.alert this.sharedService.alert-success">
      We have sent a password reset link <br> to the email address of the account that you given.<br>
      Please check your email and click on the link to reset the password.
      </p>
      <p *ngIf="sent" >
      <button  class="btn btn-primary"  [routerLink]='' (click)="onClose()"><i class="fa fa-close"></i> Close</button>
