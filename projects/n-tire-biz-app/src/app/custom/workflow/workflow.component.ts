...
export class workflowComponent implements ControlValueAccessor {
    ...
    */
    ...
    onSubmitData(bclear: any) {
        ...
        this.formData = this.boworkflowForm.value;
        this.formData.customfield = JSON.stringify(customfields);
        this.formData.attachment = JSON.stringify(this.attachmentfieldjson);
    ...
    insertRecord(bclear: any) {
        this.boworkflowservice.saveOrUpdate_boworkflows(this.formdata).subscribe(
            (res: any) => {
                //debugger;
