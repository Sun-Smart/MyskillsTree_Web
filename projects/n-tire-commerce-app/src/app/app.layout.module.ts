...
export const paths = [
    {
        ...
        children: [
            ...
            {//CalendarComponent   //, component: LayoutComponent,
                path: '',
                children: [
                    { path: 'ecmcustomerbasketattributes', loadChildren: () => import('../../../n-tire-commerce-app/src/app/pages/forms/ecmcustomerbasketattribute/ecmcustomerbasketattribute.module').then(m => m.ecmcustomerbasketattributeModule) },
{ path: 'ecmreviews', loadChildren: () => import('../../../n-tire-commerce-app/src/app/pages/forms/ecmreview/ecmreview.module').then(m => m.ecmreviewModule) },
{ path: 'ecmspecials', loadChildren: () => import('../../../n-tire-commerce-app/src/app/pages/forms/ecmspecial/ecmspecial.module').then(m => m.ecmspecialModule) },
